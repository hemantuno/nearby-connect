...
//    protected static final String SERVICE_ID = "com.google.location.nearby.apps.walkietalkie.automatic.SERVICE_ID";
    ...
    public NearbyDsvManager(Context ctx, final EventListener listener,String SERVICE_ID ) {
